...
@Component({
  ...
  standalone: true,
  imports: [IonIcon, IonContent, IonHeader, IonTitle, IonToolbar, CommonModule, FormsModule, MenuComponent, GetTableComponent, IonMenu, IonButtons, IonMenuButton, AlertComponent]
})
